...
class AddressBook:
    def __init__(self):
        ...
        Entry(frame3, textvariable = self.cityVar, width = 5).grid(
            row = 1, column = 2)
        ...
        Entry(frame3, textvariable = self.zipVar, width = 5).grid(row = 1,
                                                                  column = 6)
    ...
    def saveAddress(self):
        outfile = open(r'C:\Users\DagiMan\Desktop\Python Programming - CBT Nuggets\Exercise\address.dat', 'wb')
    ...
    def loadAddress(self):
        if not os.path.isfile('C:/Users/DagiMan/Desktop/Python Programming - CBT Nuggets/Exercise/address.dat'):
            return []  # Return an empty list

        try:
            infile = open(r'C:\Users\DagiMan\Desktop\Python Programming - CBT Nuggets\Exercise\address.dat', 'rb')
